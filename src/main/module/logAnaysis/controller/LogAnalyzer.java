package module.logAnaysis.controller;
...
public class LogAnalyzer {
    ...
    public void parseLogFile(int startRowNum, int endRowNum) {
        ...
        /* 파싱 */
        for (int i = 0; i <= (endRowNum - startRowNum); i++) {
...
8. view버튼과report 생성버튼을 만들고 view버튼이 클릭되면 위의 내용을 Dialog에 출력하고, report생성 버튼이 클릭되면 c:/dev/report폴더를 생성한 후 “report_생성날짜.dat” 파일을 생성하여 1~6까지의 작업을 모두 출력한다.
