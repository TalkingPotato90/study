(function () {/*VERSION:221018*/
    ...
    !function (a, b, c, d, e) {
        ...
        var o = b, p = a.CONT, q = a.MODEL, r = a.viewUtils, s = a.frame, t = a.themePreprocessor,
            u = "http:" !== a.CONT.PROTOCOL, v = (u ? "https:" : "http:") + "//postcode.map.daum.net/search",
            w = encodeURIComponent(p.PROTOCOL + "//" + e.host), x = encodeURIComponent(e.pathname), y = "",
            z = v + "?origin=" + w;
        s.init(z, x, y), l.prototype = {
            open: function (a) {
                if (!n(!1, "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.")) {
                    ...
                    b = g(b, a), b = h(b, a), b = i(b, a), b = j(b, a), b = k(b, a), b = o.extend(b, {viewType: "popup"}), s.popup.create(b)
                }
            }, embed: function (a, b) {
                if (!n(!1, "[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다.")) {
