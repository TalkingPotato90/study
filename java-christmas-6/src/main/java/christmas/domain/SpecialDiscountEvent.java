...
public class SpecialDiscountEvent implements Event {
    ...
    private static final Set<LocalDate> SPECIAL_DATES = Set.of(
            ...
            LocalDate.of(2023, 12, 22), LocalDate.of(2023, 12, 24), LocalDate.of(2023, 12, 25), LocalDate.of(2023, 12, 31)
    );
    ...
    public int calculateDiscount(LocalDate visitDate, int totalOrderAmount) {
        if (totalOrderAmount >= 10000 && SPECIAL_DATES.contains(visitDate)) {
